...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self=[super initWithFrame:frame]) {
        ...
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"middleIcon"] forState:UIControlStateNormal];
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"middleIcon"] forState:UIControlStateHighlighted];
...
//    self.plusBtn.centerY = self.height * 0.5 - 2*LBMagin ;
    ...
    self.plusBtn.frame = CGRectMake(kSCREEN_WIDTH/2-self.plusBtn.currentBackgroundImage.size.width/2, -20, self.plusBtn.currentBackgroundImage.size.width, self.plusBtn.currentBackgroundImage.size.height);
